        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center justify-between mb-6 print:hidden">
            ...
            <button
              ...
              className="rounded-lg border border-gray-300 bg-white px-4 py-2 text-xs font-semibold text-gray-700 hover:bg-gray-100 transition shadow-xs inline-flex items-center gap-1.5"
            >
                    ...
                    {report.content.topThemes.map((theme: any, idx: number) => (
                      <div key={idx} className="py-3 flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          ...
                          {theme.isSpiking && (
                            <span className="rounded bg-red-100 px-2 py-0.2 text-[10px] font-bold text-red-700 uppercase tracking-wide">
                              Surge
                            </span>
                          )}
                        </div>
